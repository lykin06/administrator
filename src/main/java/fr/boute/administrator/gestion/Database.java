...
import fr.boute.administrator.personnel.*;
import fr.boute.administrator.serialization.Text;
...
public class Database {
     ...
     * @throws Exception if the identifant is not between 1 and 3
     */
    ...
    /**
     * @param teachers the teachers list to set
     */
    ...
    /**
     * @param students the students list to set
     */
    ...
    /**
     * @param administrators the administrators list to set
     */
    ...
    /**
     * @param unknown the unknown list to set
     */
